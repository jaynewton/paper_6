...
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_1.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_2.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_3.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_4.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_5.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_6.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_7.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_8.RData")
#load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_individual_m_9.RData")
load("F:/我的论文/第五篇/RData/FF3F_A_nm.RData")

da_m <- da_all_m[,.(ym,SecCode,max_ret,ret_e,size)]
da_m <- merge(da_m,da_individual_m_1,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_2,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_3,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_4,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_5,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_6,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_7,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_8,by=c("ym","SecCode")) 
#da_m <- merge(da_m,da_individual_m_9,by=c("ym","SecCode")) 
