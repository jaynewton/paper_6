...
da_ivol <- da_ivol[ym>=ymd("1999-8-1") & ym<=ymd("2009-12-1"),]
#da_ivol <- da_ivol[ym>=ymd("2009-8-1") & ym<=ymd("2014-12-1"),]
#da_ivol <- da_ivol[ym>=ymd("2014-8-1") & ym<=ymd("2017-12-1"),]
...
da_ivol_6m_1 <- da_ivol_m
#da_ivol_6m_2 <- da_ivol_m
#da_ivol_6m_3 <- da_ivol_m

save(da_ivol_6m_1,file="C:/Users/Ding/Desktop/da_ivol_6m_1.RData")
#save(da_ivol_6m_2,file="C:/Users/Ding/Desktop/da_ivol_6m_2.RData")
#save(da_ivol_6m_3,file="C:/Users/Ding/Desktop/da_ivol_6m_3.RData")

rm(list=ls())

#################################
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_ivol_6m_1.RData")
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_ivol_6m_2.RData")
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_ivol_6m_3.RData")

da_ivol_6m <- rbind(da_ivol_6m_1,da_ivol_6m_2,da_ivol_6m_3)

save(da_ivol_6m,file="C:/Users/Ding/Desktop/da_ivol_6m.RData")

#################################
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_ivol_6m.RData")

da_ivol_6m[,`:=`(percentile_ivol=percent_rank(ivol),percentile_isk=percent_rank(isk)),by=ym]
# Note: percent_rank() is different from rank()/(.N-1) when there exists NA.

da_percentile_ivol_6m <- da_ivol_6m[,.(ym,SecCode,percentile_ivol,percentile_isk)]

save(da_percentile_ivol_6m,file="C:/Users/Ding/Desktop/da_percentile_ivol_6m.RData")
