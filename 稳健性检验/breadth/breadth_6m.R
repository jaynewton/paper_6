...
da_breadth <- da_tsk[ym>=ymd("1999-8-1") & ym<=ymd("2009-12-1"),]
#da_breadth <- da_tsk[ym>=ymd("2009-8-1") & ym<=ymd("2014-12-1"),]
#da_breadth <- da_tsk[ym>=ymd("2014-8-1") & ym<=ymd("2017-12-1"),]
...
da_breadth_6m_1 <- da_breadth_m
#da_breadth_6m_2 <- da_breadth_m
#da_breadth_6m_3 <- da_breadth_m

save(da_breadth_6m_1,file="C:/Users/Ding/Desktop/da_breadth_6m_1.RData")
#save(da_breadth_6m_2,file="C:/Users/Ding/Desktop/da_breadth_6m_2.RData")
#save(da_breadth_6m_3,file="C:/Users/Ding/Desktop/da_breadth_6m_3.RData")

rm(list=ls())

#################################
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_breadth_6m_1.RData")
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_breadth_6m_2.RData")
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_breadth_6m_3.RData")

da_breadth_6m <- rbind(da_breadth_6m_1,da_breadth_6m_2,da_breadth_6m_3)

save(da_breadth_6m,file="C:/Users/Ding/Desktop/da_breadth_6m.RData")
