...
da_tsk <- da_tsk[ym>=ymd("1999-11-1") & ym<=ymd("2009-12-1"),]
#da_tsk <- da_tsk[ym>=ymd("2009-11-1") & ym<=ymd("2014-12-1"),]
#da_tsk <- da_tsk[ym>=ymd("2014-11-1") & ym<=ymd("2017-12-1"),]
...
da_tsk_3m_1 <- da_tsk_m
#da_tsk_3m_2 <- da_tsk_m
#da_tsk_3m_3 <- da_tsk_m

save(da_tsk_3m_1,file="C:/Users/Ding/Desktop/da_tsk_3m_1.RData")
#save(da_tsk_3m_2,file="C:/Users/Ding/Desktop/da_tsk_3m_2.RData")
#save(da_tsk_3m_3,file="C:/Users/Ding/Desktop/da_tsk_3m_3.RData")

rm(list=ls())

#################################
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_tsk_3m_1.RData")
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_tsk_3m_2.RData")
load("F:/我的论文/第五篇/主代码/individual investor preference/RData/da_tsk_3m_3.RData")

da_tsk_3m <- rbind(da_tsk_3m_1,da_tsk_3m_2,da_tsk_3m_3)

save(da_tsk_3m,file="C:/Users/Ding/Desktop/da_tsk_3m.RData")
